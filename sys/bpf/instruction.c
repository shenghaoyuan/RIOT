...
/*
void print_regmap (uint64_t* regmap){
    print_u64_dec(regmap[0]);
    printf("(R0)\n");
    print_u64_dec(regmap[1]);
    printf("(R1)\n");
    print_u64_dec(regmap[2]);
    printf("(R2)\n");
    print_u64_dec(regmap[3]);
    printf("(R3)\n");
    print_u64_dec(regmap[4]);
    printf("(R4)\n");
    print_u64_dec(regmap[5]);
    printf("(R5)\n");
    print_u64_dec(regmap[6]);
    printf("(R6)\n");
    print_u64_dec(regmap[7]);
    printf("(R7)\n");
    print_u64_dec(regmap[8]);
    printf("(R8)\n");
    print_u64_dec(regmap[9]);
    printf("(R9)\n");
    print_u64_dec(regmap[10]);
    printf("(R10)\n");
  return ;
} */
...
int bpf_run(bpf_t *bpf, const void *ctx, int64_t *result)
{
    ...
    const bpf_instruction_t *pc= (const bpf_instruction_t*)bpf->application; //rbpf_text(bpf);
    ...
    while (!end) {
        ...
        /*
          intptr_t instruction = (uint8_t*)pc - bpf->application;
          print_u64_hex(*pc); printf("(PC)\n"); printf(" pc: %d\n", instruction/8); print_regmap(&regmap);
  	*/
        pc++;
